...
/* True once ShaccVSH loaded successfully -- i.e. GLSL_CompileGPUShader can
 * fall back to a real source compile if a shipped shader binary is missing. */
qboolean PS4_ShaccAvailable(void)
{
	return s_shaccModuleId >= 0;
}
