...
// Verified byte-for-byte identical between Classic (proto 43) and ioEF (proto 24):
// same seed/xor/transpose math, same SCRAMBLE_START. One shared implementation.
...
#ifdef ELITEFORCE
		// ioEF: skipped here in compat (legacy proto 24) mode -- diverges from
		// Classic, which always bumps it. Verified against ioEF's net_chan.c.
		if(!chan->compat)
#endif
