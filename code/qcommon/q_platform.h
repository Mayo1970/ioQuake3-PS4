...
#if (defined(__FreeBSD__) || defined(__OpenBSD__) || defined(__NetBSD__)) && !defined(__ORBIS__)
...
// PS4 uses .prx for loadable modules; statically linked for now
#define DLL_EXT ".prx"

// The PS4 AMD Jaguar CPU is x86-64, so the JIT should work
// if we can allocate executable memory. Disabled until tested.
// #define HAVE_VM_COMPILED
